...
namespace RoombotSearch
{
    ...
    class ClassBidirectionalSearchSolver
    {
        ...
        public ClassBidirectionalSearchSolver(INCLUDE_OR m1, ClassPuzzle PuzzleToBeSolved)
        {
        ...
        public ClassPuzzle SolveIt()
        {
            ...
            /*Task task_fwd = Task.Factory.StartNew(() => DoSolve(true,P_fwd));
            Task task_bwd = Task.Factory.StartNew(() => DoSolve(false,P_bwd));

            Task.WaitAll(task_fwd, task_bwd);*/
