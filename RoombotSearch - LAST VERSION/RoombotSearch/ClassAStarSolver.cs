...
namespace RoombotSearch
{
    ...
    class ClassAStarSolver
    {
        ...
        public ClassAStarSolver(INCLUDE_OR m1 ,ClassPuzzle PuzzleToBeSolved)
        {
            P = PuzzleToBeSolved;
            with_m1 = m1;
        ...
        private bool _AreNodesSame(ClassNode N1, ClassNode N2)      // Checks whether 2 nodes have the same state or not
        {
        ...
        private int _CalcHeur(ClassNode Nh)
        {
            int He = 0;
                        ...
                        if (Nh.OccupancyGrid[i, j, k])
                        {
                            ...
                            for (int ii = 0; ii < Nh.NodeSizeZ; ii++)
                                for (int jj = 0; jj < Nh.NodeSizeY; jj++)
                                {
                                    ...
                                    {
                                        if (P.GoalNode.OccupancyGrid[ii, jj, kk])
                                        {
